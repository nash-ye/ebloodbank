...
<form id="form-donors-filter" class="form-inline" method="POST">
    ...
    <div class="form-group">
        <label>
            <?= EBB\escHTML(d__('winry', 'Blood Group')) ?>
            <?=
                EBB\getBloodGroupsDropdown([
                    ...
                    'placeholder_text'  => d__('winry', 'All'),
                ])
            ?>
        </label>
        <div class="checkbox">
            <label>
                ...
                <?= EBB\escHTML(d__('winry', 'Include alternatives?')) ?>
            </label>
        </div>
    </div>
    ...
    <div class="form-group">
        <label>
            <?= EBB\escHTML(d__('winry', 'District')) ?>
            <select name="district_id"  class="form-control">
                <option value="-1"><?= EBB\escHTML(d__('winry', 'All')) ?></option>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-default"><?= EBB\escHTML(d__('winry', 'Search')) ?></button>
    </div>
