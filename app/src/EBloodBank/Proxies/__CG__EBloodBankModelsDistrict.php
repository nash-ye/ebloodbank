 ...
 */
class District extends \EBloodBank\Models\District implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'city', 'created_at', 'created_by', 'donors'];
        }
