...
?>
    ...
    <div class="btn-toolbar">
        <div class="btn-group" role="group">
            <?= EBB\getDistrictsLink(['content' => d__('winry', 'View'), 'atts' => ['class' => 'btn btn-default btn-view btn-view-districts']]) ?>
            <?= EBB\getAddDistrictLink(['content' => d__('winry', 'Add New'), 'atts' => ['class' => 'btn btn-primary btn-add btn-add-district']]) ?>
        </div>
    </div>
